...
namespace commands.extensions
{
    public static class Builder
    {
        ...
        public static IBuilder<TResult> Add<TResult>(this IBuilder builder, Func<CancellationToken, TResult> func) => builder.Add(new Source<TResult>(func));
        public static IBuilder Add<TArgument>(this IBuilder<TArgument> builder, Action<TArgument> action) => builder.Add(new Sink<TArgument>(action));
        public static IBuilder Add<TArgument>(this IBuilder<TArgument> builder, Action<TArgument, CancellationToken> action) => builder.Add(new Sink<TArgument>(action));
